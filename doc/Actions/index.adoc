...
|link:key_generation.adoc[generate]                             | Generates an asymmetric key on a specific slot
...
|link:test-decapsulation.adoc[test-decapsulate]                 | Tests the ML-KEM decapsulation function
